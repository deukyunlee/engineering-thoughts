...
![multi-master-replication](images/unique_id/multi-master-replication.png)
...
![uuid](images/unique_id/uuid.png)
...
![ticket-server](images/unique_id/ticket-server.png)
...
![snowflake](images/unique_id/snowflake.png)
...
- 하위호환성을 생각해야 할 텐데, 첫 번째 사인 비트를 `0: v1`, `1: v2` 식으로 버전 플래그처럼 관리?
- 관리 로직이 복잡해질 것 같다.
