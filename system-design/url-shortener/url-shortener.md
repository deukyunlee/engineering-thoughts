...
![client-server-communication](images/client-server-communication.png)
...
![url-count](images/url-count.png)
...
여기서 "유일한 ID 생성"은 [유일 ID 생성기](../unique-id/unique-id.md)에서 다룬 Snowflake, 티켓 서버 등의 방식을 활용할 수 있다.
